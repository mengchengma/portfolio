...
const Contact = () => {
    ...
    const onSubmit = async (event) => {
        ...
        formData.append("access_key", "b2dca2bc-a55f-4b4d-a900-9f7bdad87a46");
  ...
  return (
    <div id='contact' className={`w-full px-[12%] py-10 scroll-mt-20 bg-[url("${process.env.NODE_ENV === 'production' ? '/portfolio' : ''}/footer-bg-color.png")] bg-no-repeat bg-center bg-[length:90%_auto]`}>
        <h4 className='text-center mb-2 text-lg font-Ovo'>Connect with me!</h4>
        <h2 className='text-center text-5xl font-Ovo'>Get in touch</h2>

        <p className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>
            I'd love to hear from you! If you have any questions, comments, or feedback, please use this form below.
        </p>
        ...
        <form onSubmit={onSubmit} className='max-w-2xl mx-auto'>
            ...
            Submit now <Image src={assets.right_arrow_white} alt='' width={16} height={16} className='w-4'/></button>
